...
(function (factory) {
  ...
  Slick.prototype.asNavFor = function (index) {
    var _ = this,
      asNavFor =
        _.options.asNavFor != null ? $(_.options.asNavFor).getSlick() : null;
  ...
  Slick.prototype.checkResponsive = function () {
    // check rrsponsive to change width
      ...
      case "index":
        var index =
          event.data.index === 0
            ? 0
            : event.data.index ||
              $(event.target).parent().index() * _.options.slidesToScroll;
  ...
  Slick.prototype.setDimensions = function () {
    ...
    if (
      _.$slideTrack.parent().parent().parent().attr("class") ==
        "news-content" &&
      _.slideWidth - offset > 0
    ) {
      $("#tabs-1 .news-content .multi-image .slick-list .slick-track")
        .children(".slick-slide")
        .width(_.slideWidth - offset);
      $("#tabs-1 .news-content .multi-image .slick-list .slick-track").width(
        _.slideWidth * 30
      );
      $("#tabs-2 .news-content .multi-image .slick-list .slick-track")
        .children(".slick-slide")
        .css({ width: _.slideWidth - offset + "px" });
      $("#tabs-2 .news-content .multi-image .slick-list .slick-track").width(
        _.slideWidth * 30
      );
    }
  };
  ...
  Slick.prototype.updateArrows = function () {
    ...
    if (
      ...
      if (_.currentSlide === 0) {
        ...
        _.currentSlide > _.slideCount - _.options.slidesToShow + centerOffset &&
        _.options.centerMode === true
      ) {
        _.$nextArrow.addClass("slick-disabled");
        _.$prevArrow.removeClass("slick-disabled");
